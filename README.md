...
* [https://dev.to/nohehf/handling-multiple-tokens-with-a-modern-solidity-architecture-via-diamonds-erc1155-1h7e](Handling multiple tokens, with a modern solidity architecture via Diamonds & ERC1155.)
